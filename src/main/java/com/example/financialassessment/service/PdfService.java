...
public class PdfService {
    ...
    private final String DEPENDENTS_NAME = "Name";
    private final String DEPENDENTS_DOB = "Date of Birth";
    private final String DEPENDENTS_RELATION = "Relationship";
